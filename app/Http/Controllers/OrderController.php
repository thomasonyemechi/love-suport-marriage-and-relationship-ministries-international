...
class OrderController extends MailController
{
    ...
    //         return back()->with('errors', do_er($user_info['errors']));
    //     }
    //     $user_id = $user_info['user_id'];
    //     $tracking_id = $user_info['track_id'];
    ...
    //         return back()->with('error', 'Transaction was cancelled, pls try again');
